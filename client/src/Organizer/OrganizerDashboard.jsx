...
class OrganizerDashboard extends Component{
    ...
    render(){
        ...
        return (
            <div>
                <Grid container >
                    <AppBar position="static" style={{ background : "#f0a564", color : "#fff"}} >
                        <Toolbar>
                            ...
                            >
                                ...
                                <Button variant="outlined" style={{ background: "#f0a564", color : "#000000", borderColor : "#fff", marginLeft : "10px"}} onClick={this.logoutHandler}>
                                    Logout
                                </Button>
                            </Grid>
                ...
                >
                    ...
                    <Grid item xs={9}>
                        <Paper 
                            ...
                            style={{ background : "#f0a564" , margin : "20px"}}
                        >
                            <Grid item xs={12}>
                                {Option}
                            </Grid> 
